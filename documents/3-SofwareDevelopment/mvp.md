...
| MVP-030 | Work Items Core Schema & Registry | Implement work item types registry, JSON schemas, and extend agent types with taxonomy fields (autonomy, budget, safety, identity) | Not Started | P1       | Medium | Go, ArangoDB, JSON Schema | MVP-029      | [MVP-030.md](mvp-details/MVP-030.md) |
...
| Task ID | Title                     | Description                                                | Status      | Priority | Effort | Skills Required       | Dependencies | Details |
| ------- | ------------------------- | ---------------------------------------------------------- | ----------- | -------- | ------ | --------------------- | ------------ | ------- |
| MVP-043 | Work Items UI Module      | Build complete Work Items management UI with CRUD operations, AI refinement, templates, deliverables/dependencies management, filtering, and export (PDF/Markdown/JSON) | Not Started | P1       | Medium | Go, Templ, Frontend Dev, HTMX | MVP-029      | [MVP-043.md](mvp-details/MVP-043.md) |
| MVP-044 | Agent Types UI Module     | Build Agent Types definition and management UI with type catalog, capability specification, taxonomy fields, token budgets, templates, and export (PDF/Markdown/JSON) | Not Started | P1       | Medium | Go, Templ, Frontend Dev | MVP-043      | [MVP-044.md](mvp-details/MVP-044.md) |
...
| MVP-042 | AI-Powered Agency Creator | Implement AI-driven agency creation flow with text upload, selective generation (introduction, goals, work items, agent types, RACI), and batch AI generation | Not Started | P1       | High   | Go, Templ, AI/LLM, Frontend Dev | MVP-047      | [MVP-042.md](mvp-details/MVP-042.md) |
