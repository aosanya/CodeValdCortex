...
| MVP-054 | Work Items Enhanced Deliverables Structure | Implement hierarchical deliverable tree system with DeliverableNode model (folder/file types), drag-and-drop Tree Builder UI, prompt instructions per node with inheritance, validation constraints, and prompt composition service for hierarchical context | 🚀 In Progress | P0 | Medium | Go, Templ, HTMX, Frontend Dev | MVP-WI-008 | [MVP-054.md](mvp-details/MVP-054.md) |
