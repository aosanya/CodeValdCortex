...
| Task ID | Title | Description | Status | Priority | Effort | Skills | Dependencies | Details |
|---------|-------|-------------|--------|----------|--------|--------|--------------|---------|
| MVP-WI-006 | File Explorer API & UI | Build file/folder browsing API, file CRUD operations, directory tree rendering, Git mechanics abstraction, Templ-based file explorer UI with breadcrumbs and navigation | � In Progress | P0 | High | Go, Templ, HTMX, Frontend Dev | ~~MVP-WI-005~~ ✅ | [work-items-integration/git-based-document-system.md](mvp-details/work-items-integration/git-based-document-system.md) |
