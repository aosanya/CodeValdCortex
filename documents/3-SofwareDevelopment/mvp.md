...
| Task ID | Title                     | Description                                                | Status      | Priority | Effort | Skills Required       | Dependencies | Details |
| ------- | ------------------------- | ---------------------------------------------------------- | ----------- | -------- | ------ | --------------------- | ------------ | ------- |
| MVP-044 | Agent Types UI Module     | Build Agent Types definition and management UI with type catalog, capability specification, taxonomy fields, token budgets, templates, and export (PDF/Markdown/JSON) | Not Started | P1       | Medium | Go, Templ, Frontend Dev | MVP-029      | [MVP-044.md](mvp-details/MVP-044.md) |
