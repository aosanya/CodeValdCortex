...
**Tabbed Interface**:
- 💰 **Token Budgets**: Manage token allocations
- ⏱️ **Rate Limits**: Configure API rate limiting
- 📊 **Resource Quotas**: Set resource constraints
- 🤖 **AI Models**: Select and prioritize models
- 💵 **Cost Controls**: Budget and spending management
...
<div class="tab-content" id="token-budgets">
  ...
  <div class="box mt-5">
    <h2 class="title is-4">Agent Type Token Budgets</h2>
  ...
  <div class="box">
    <p class="subtitle is-6">Sensor Agent Type (AT-001)</p>
      ...
      <tbody>
        <tr>
          ...
          <td>
            ...
            <p class="help">Max: 1,000,000 (Agent Type Budget)</p>
          </td>
          <td>45,000</td>
  ...
  <div class="notification is-info is-light mt-4">
    <strong>ℹ️ Budget Rules:</strong>
    <ul>
      <li>Each agent's budget must be ≤ its agent type's total budget</li>
...
- [ ] Token budgets can be set at agent type level
- [ ] Individual agent budgets can be configured
- [ ] Budget constraints enforced (agent ≤ type budget)
...
- **Agent Type Level**: Budget allocation per agent type
- **Individual Agent Level**: Budget per specific agent instance
- Constraint: Sum of agent budgets ≤ agent type budget ≤ agency budget
