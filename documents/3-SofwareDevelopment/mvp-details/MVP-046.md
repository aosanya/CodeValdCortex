...
<div class="tab-content" id="token-budgets">
  ...
  <div class="notification is-info is-light mt-4">
    ...
    <ul>
      <li>Each agent's budget must be ≤ its role's total budget</li>
...
PUT    /api/v1/agencies/{id}/config/token-budgets/roles/{key}
...
- Constraint: Sum of agent budgets ≤ role budget ≤ agency budget
