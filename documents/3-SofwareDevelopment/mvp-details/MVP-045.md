...
type RACIActivity struct {
    ...
    Assignments map[string]models.RACIRole `json:"assignments"` // role_name -> RACI role
}

type models.RACIRole string
const (
    Responsible models.RACIRole = "R"  // Does the work
    Accountable models.RACIRole = "A"  // Ultimately answerable
    Consulted   models.RACIRole = "C"  // Provides input
    Informed    models.RACIRole = "I"  // Kept in the loop
)
```
