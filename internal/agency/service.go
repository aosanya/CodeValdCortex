...
func (s *service) GetAgencyOverview(ctx context.Context, agencyID string) (*Overview, error) {
	// Verify agency exists
...
func (s *service) UpdateAgencyOverview(ctx context.Context, agencyID string, introduction string) error {
	// Verify agency exists
	_, err := s.repo.GetByID(ctx, agencyID)
	if err != nil {
