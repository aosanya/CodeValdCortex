...
import (
	...
	ai "github.com/aosanya/CodeValdCortex/internal/builder/ai"
...
type RefineIntroductionRequest struct {
	...
	ConversationHistory []ai.Message `json:"conversation_history,omitempty"` // Recent chat messages for context
}
