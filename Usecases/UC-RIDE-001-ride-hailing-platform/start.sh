...
# UC-RIDE-001: Ride Hailing Platform Startup Script
...
echo "=========================================="
echo "UC-RIDE-001: Ride Hailing Platform"
echo "=========================================="
echo ""
...
echo "  Rider Agent:              $CVXC_AGENT_RIDER_ENABLED"
echo "  Driver Agent:             $CVXC_AGENT_DRIVER_ENABLED"
echo "  Ride Agent:               $CVXC_AGENT_RIDE_ENABLED"
...
echo "Ride Configuration:"
echo "  Matching Algorithm:       $CVXC_RIDE_MATCHING_ALGORITHM"
echo "  Surge Pricing:            $CVXC_RIDE_SURGE_PRICING_ENABLED"
echo "  Ride Pooling:             $CVXC_RIDE_POOLING_ENABLED"
echo "  Max Wait Time:            $CVXC_RIDE_MAX_WAIT_TIME_MINUTES minutes"
echo ""

# Build the application
echo "Building Ride Hailing Platform..."
cd "$PROJECT_ROOT"
